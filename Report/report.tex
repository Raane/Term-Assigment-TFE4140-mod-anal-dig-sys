...
\begin{titlepage}
    \vspace*{2cm}
    \begin{abstract}
The Norwegian Univercity of Science and Technology is going to launch a student satellite.
This paper explores a solution with a Liaison module for the satellite, that will handle multiple redundant computing systems onboard the satelite.
This redundancy will help increase the expected lifetime of the satellite by allowing the system to remain fully functional even with one or more computing systems failed.
The Liasion module will also ensure error correction and detection on transmitted data.
This is achieved through hamming codes, handling one bit error correction and two bit error detection.
This paper also explores the testing, verification and synthesis of this design.
    \end{abstract}
\end{titlepage}
